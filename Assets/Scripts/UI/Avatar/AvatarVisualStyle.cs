...
public class AvatarVisualStyle : ScriptableObject {
    ...
    public Color frameSelected = new Color(1f, 0.85f, 0.25f, 1f);  // gold
    public Color frameActive   = new Color(0.2f, 0.9f, 0.5f, 1f);   // green
    ...
    [Header("Active glow (optional backdrop)")]
